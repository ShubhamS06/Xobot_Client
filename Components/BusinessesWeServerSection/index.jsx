...
function BusinessesWeServerSection({ styles }) {
    ...
    const content = {
        'Small Business': {
            ...
            description: 'Enhance efficiency and customer engagement with Xobot, providing 24/7 support and automating repetitive tasks.',
            image: '/conversion-rate-optimizationamico-1.svg',
        },
        'Professional service': {
            title: 'Streamline your professional services',
            description: 'Deliver top-notch professional services by automating client interactions and scheduling appointments with Xobot.',
            image: '/conversion-rate-optimizationamico-1.svg',
        },
        'Saas': {
            title: 'Streamline your sales process',
            description: 'Transform your lead management by having Xobot immediately respond to inquiries, qualify your leads, and book demos for your sales team, all whilst integrating with your CRM.',
            image: '/conversion-rate-optimizationamico-1.svg',
        },
        'Enterprise': {
            title: 'Scale your enterprise operations',
            description: 'Leverage Xobot to handle large volumes of customer interactions, ensuring consistency and efficiency across your enterprise.',
            image: '/conversion-rate-optimizationamico-1.svg',
        },
    };
